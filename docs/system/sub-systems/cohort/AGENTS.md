...
- **Organ:** `cohort`
- **Rung:** system (`docs/system/sub-systems/cohort/`)
- **Contract docs (canon):** `foundations/38-cohort-weave-multiplayer`
...
*(none yet — author one with `arch.py doc add --organ cohort --title ...`)*
