...
- **The closure** — Foundations/06 §7.4: the 4th-density harvest is the **Violet event** at the sub-octave closure (L8 Turquoise completed), scripted epilogue — never a stage
...
At the closure (L8 Turquoise completed; the Violet event), the player's polarity crystallization determines their harvest:
