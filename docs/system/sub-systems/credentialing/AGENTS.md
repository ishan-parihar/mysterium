# credentialing - organ router

<!-- arch:auto-zone:start -->
### Identity (generated from _org.yaml - do not edit)

- **Organ:** `credentialing`
- **Rung:** system (`docs/system/sub-systems/credentialing/`)
- **Contract docs (canon):** `foundations/41-global-recognition-credentialing`, `foundations/38-cohort-weave-multiplayer`
- **Code it describes:** `src/core/credential`
...
- [claim-ledger-recognition.md](./claim-ledger-recognition.md) — Claim Ledger & Recognition
