...
**Progress 2026-09-24:** **d1 ✅ · d2a ✅ · d2b ✅ · d2c ✅ · d4 ✅ · d5 ✅.** Remaining: **d3**
(the CLI split + calibration extraction — the largest single item, and the one Q10 attaches a ruling
to), **d6** (Laya / System-1 adapter), **d7** (K1 probe validation). Kernel gates **37** (G36/G37
added; `tests/validation/Benchmark.test.ts` asserts the literal count).
