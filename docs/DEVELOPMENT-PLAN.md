...
- **Documentation + KB integrity** — `_org.yaml → pending`: `RT-ARCHIVE-MIGRATIONS` and
  `KB-FOUNDATIONS-INGEST`. Closed in the 2026-09-20/21 conformance passes: gate fixtures
  ...
  `house` claim against upstream artifacts, and is queryable as `arch skills`).
